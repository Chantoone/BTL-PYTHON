...
Encode_List_Users_str = [np.array2string(encoding, separator=', ') if encoding is not None else None for encoding in Encode_List_Users]
df=pd.DataFrame({"face_encoding":Encode_List_Users_str,"id":ID_USERS})
